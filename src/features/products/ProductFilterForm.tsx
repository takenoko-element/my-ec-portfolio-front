      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
        ...
        <div>
          ...
          <select
            ...
            disabled={isLoading}
            className="mt-1 block w-full rounded-md border border-gray-400 shadow-sm focus:border-2 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2"
          >
        ...
        <div>
          ...
          <div className="flex space-x-2">
            ...
            <button
              type="submit"
              className="mt-1 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              検索
            </button>
          </div>
